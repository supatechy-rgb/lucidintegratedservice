...
import { Award, Leaf, Shield, Users, Heart, Target, Eye } from "lucide-react";
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          y: 0
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold mb-6">Creating   <span className="text-secondary">Spotless</span> ​Space
            </h1>
